...
|---|---|---|---|
| **Document ID** | CSC-SVD-001 | **Version** | 1.6 |
...
|---|---|---|
| F-001 | Package refactor: `cstylecheck.py` monolith split into `src/cstylecheck/` package (12 sub-modules) | [#65](https://github.com/dermot-murphy/CStyleCheck/issues/65) |
...
| Test Suite | `tests/` (1041 tests) | 1.2.0 | Released |
