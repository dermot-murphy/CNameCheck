...
src/
    ...
    cstylecheck/            # checker package (10 sub-modules)
        ...
        output.py           # text / JSON / SARIF formatters, Tee, summary
...
tests/
    ...
    test_declared_not_defined.py # 29 tests: misc.declared_not_defined
